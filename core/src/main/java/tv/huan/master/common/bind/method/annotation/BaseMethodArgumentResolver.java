 ...
 */
package tv.huan.master.common.bind.method.annotation;
        ...
        for (String name : variables.keySet()) {
            if (name.startsWith(namePrefix)) {
                ...
                if (subPrefix) {
                    ...
                    result.put(name.substring(namePrefixLength + 1), variables.get(name));
                } else {
        ...
        while (parameterNames.hasNext()) {
            ...
            if (name.startsWith(namePrefix)) {
                ...
                if (subPrefix) {
                    ...
                    result.put(name.substring(namePrefixLength + 1), request.getParameter(name));
                } else {
