...
import tv.huan.master.util.TimeUtil;
...
public class ElkClientLogService {
    ...
    public EasyUiGridResponse find(EasyUiPageRequest request, Searchable searchable) {
...
//        Page page =elasticsearchTemplate.queryForPage(criteriaQuery, ClientLog.class);
        ...
        SearchResponse searchResponse = client.prepareSearch("acs_client*")// 检索的目录
                ...
                .setFrom(request.getFirstResult()).setSize(request.getRows()).setExplain(true)
                .execute().actionGet();
        ...
        EasyUiGridResponse response = new EasyUiGridResponse();
